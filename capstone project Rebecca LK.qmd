...
#| tbl-cap: "When people wash their hands, by gender"
...
ggplot(wash_by_gender2_long,aes(fill=gender, x=activity, y=value))+geom_bar(position="dodge", stat="identity")+ 
